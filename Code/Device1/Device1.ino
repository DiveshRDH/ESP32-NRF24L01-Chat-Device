...
const uint32_t MY_CODE = 1234; // Unique code for Device 1
char recipient_code[5] = "5678"; // Default to Device 2
...
void setup() {
  ...
  radio.openWritingPipe((uint8_t*)"5678"); // Default to Device 2
  radio.openReadingPipe(1, (uint8_t*)"1234"); // Device 1's address
